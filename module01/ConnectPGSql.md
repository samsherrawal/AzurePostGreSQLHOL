...
![pgadmin](./download-pgadmin-4.png) 
...
![master-password-pgadmin](./master-password-for-pgadmin.png) 
...
![general-properties-pgadmin](./general-properties.png) 
...
![general-properties-pgadmin](./connection-properties.png) 
...
![ssl-pgadmin](./ssl-properties.png) 
...
![username-format-error-pgadmin](./username-format-error.png) 
...
![username-format-pgadmin](./username-format.png) 
...
![firewall-error-pgadmin](./firewall-error.png) 
...
![firewall-settings-pgadmin](./firewall-settings.png) 
...
![pgadmin-dashboard-pgadmin](./pgadmin-dashboard.png)
...
![pgadmin-connection-properties-pgadmin](./pgadmin-connection-properties-for-azure-database-f.png)
